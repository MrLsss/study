...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-1.png)
...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-2.png)
...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-3.png)
...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-4.png)

### RabbitMq的基本概念

下图是RabbitMQ的基本结构：

![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-5.png)
...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-6.jpg)包括：ConnectionFactory（连接管理器）、Channel（信道）、Exchange（交换器）、Queue（队列）、RoutingKey（路由键）、BindingKey（绑定键）。
...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-6.png)
...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-7.png)
...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-8.png)
...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-9.png)
...
![](https://cdn.jsdelivr.net/gh/mrlsss/images@main/RabbitMq/RabbitMq学习总结-10.png)
